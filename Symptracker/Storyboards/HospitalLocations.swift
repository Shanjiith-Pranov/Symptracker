...
class HospitalAnnotations: NSObject {
    ...
    override init(){
       //build an array of pizza loactions literally
        ...
        hospitals += [HospitalAnnotation(1.309152,103.902743, title:  "Parkway East Hospital",  subtitle: "4")]
        ...
        hospitals += [HospitalAnnotation( 1.35028,103.723, title:  "Marine Parade Polyclinic",  subtitle: "37")]
        hospitals += [HospitalAnnotation( 1.279626,103.838161, title: "Outram Polyclinic",  subtitle: "38")]
        hospitals += [HospitalAnnotation( 1.279626,103.838161, title: "Pioneer Polyclinic",  subtitle: "38")]
